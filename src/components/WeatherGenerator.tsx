...
const WeatherGenerator: React.FC = () => {
   ...
   */
  const getWeatherDetails = (season: Season, condition: string) => {
    const season_data = data[season];
